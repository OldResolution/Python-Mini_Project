...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_6.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Confirm Password", None))
        self.lineEdit_3.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Email ID", None))
